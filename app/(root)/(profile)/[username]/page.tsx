        ...
        <div className="profile-top-right">
          <div>
            <h1 className="host-name">
              ...
              <span className="host-username">@{profileData.personalDe}</span>
            </h1>
            <h2 className="host-profession">Senior Consulatant</h2>
          ...
          <div>
            ...
            <h4 className="city-details">📍Bengaluru - City in Karnataka</h4>
